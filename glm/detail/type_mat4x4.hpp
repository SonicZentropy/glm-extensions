...
namespace glm
{
	...
	public:
		...
		GLM_FUNC_DECL tmat4x4<float> Scale(glm::vec3 const & v) {
			*this = glm::scale(*this, v);
			return *this;
		}

		template<typename T>
		GLM_FUNC_DECL tmat4x4<T> Scaled(const T& x, const T& y, const T& z) {
		...
		template<typename T>
		GLM_FUNC_DECL tmat4x4<T> Translate(const T& x, const T& y, const T& z) {
			*this = glm::translate(*this, glm::vec3(x, y, z));
			return *this;
		}

		
		GLM_FUNC_DECL tmat4x4<float> Translate(glm::vec3 const & v) {
			*this = glm::translate(*this, v);
			return *this;
		}

		template<typename T>
		GLM_FUNC_DECL tmat4x4<T> Translated(const T& x, const T& y, const T& z) {
			return glm::translate(*this, glm::vec3(x, y, z));
		}

		GLM_FUNC_DECL tmat4x4<float> Translated(glm::vec3 const & v) {
			return glm::translate(*this, v);
		}
